page 90005 "Expense Ledger Entry ARQ"
{
    ApplicationArea = All;
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                {
                    ToolTip = 'Specifies the value of the Working Capital Type field.', Comment = '%';
                }
                ...
                {
                    ToolTip = 'Specifies the value of the Original Posting Date field.', Comment = '%';
                }
                ...
                {
                    ToolTip = 'Specifies the value of the Previous Year Entry No. field.', Comment = '%';
                }
                field("Next Year Entry No."; Rec."Next Year Entry No.")
                {
                    ToolTip = 'Specifies the value of the Next Year Entry No. field.', Comment = '%';
                }
                field(Year; Rec.Year)
                {
                ...
                {
                    ToolTip = 'Specifies the value of the Initial Budget field.', Comment = '%';
                }
                ...
                {
                    ToolTip = 'Specifies the value of the Charges Assumed field.', Comment = '%';
                }
                field("Available Amount"; Rec."Available Amount")
                {
                    ToolTip = 'Specifies the value of the Available Amount field.', Comment = '%';
                }
                field("Emergent Expense"; Rec."Emergent Expense")
                {
                    ToolTip = 'Specifies the value of the Emergent Expense field.', Comment = '%';
                }
                ...
                {
                    ToolTip = 'Specifies the value of the Available Endowments field.', Comment = '%';
                }
                field("Available Endowments Approval"; Rec."Available Endowments Approval")
                {
                    ToolTip = 'Specifies the value of the Available Endowments Approval field.', Comment = '%';
                }
                field("Total Accrual Before Post"; Rec."Total Accrual Before Post")
                {
                    ToolTip = 'Specifies the value of the Total Accrual Before Post field.', Comment = '%';
                }
                field("Accrual Net Amount"; Rec."Accrual Net Amount")
                {
                    ToolTip = 'Specifies the value of the Accrual Net Amount field.', Comment = '%';
                }
                field("FM Posting Type"; Rec."FM Posting Type")
                {
                    ToolTip = 'Specifies the value of the FM Posting Type field.', Comment = '%';
                }
                field("FM Vendor No."; Rec."FM Vendor No.")
                {
                    ToolTip = 'Specifies the value of the FM Vendor No. field.', Comment = '%';
                }
                ...
                {
                    ToolTip = 'Specifies the value of the Dotação Inicial field.', Comment = '%';
                }
                ...
                {
                    ToolTip = 'Specifies the value of the Dotação Corrigida field.', Comment = '%';
                }
